...
function Sidebar() {
    return (
        <div className='bg-[#003a10] min-h-screen pl-[4vw]'>
            <img src={assets.vybe_logo} className='mt-5 w-[max(10vw,100px)] hidden sm:block' alt="logo" />
            <img src={assets.vybe_logo} className='mt-5 w-[max(10vw,10px)] mr-5 block sm:hidden' alt="logo_small" />
